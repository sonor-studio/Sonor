...
struct VoiceMode: Identifiable, Codable, Equatable {
    ...
    var pasteTiming: String? // "start" or "end"
    ...
    static func loadAndMigrateModes() -> [VoiceMode] {
        ...
        // Usunięcie asystenta Markdown Note jeśli użytkownik go utworzył w poprzednich wersjach
        ...
        // Edycja i tworzenie -> Edit & Create
