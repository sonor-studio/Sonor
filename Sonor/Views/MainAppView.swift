            ...
            HStack(spacing: 0) {
                VStack(spacing: 0) {
                    ...
                    if selectedTab == .modes {
                        Text(t("AI may generate inaccurate information. Please verify important details. Note that language models generally perform best when working with English. We do not assume responsibility for outputs generated by either Whisper or LLM models."))
                            .font(.system(size: 10))
