...
#define DEFINE_PARAM(param_name, nth) \
  ...
  rb_define_method(cVADParams, #param_name, ruby_sonor_vad_params_get_ ## param_name, 0); \
  rb_define_method(cVADParams, #param_name "=", ruby_sonor_vad_params_set_ ## param_name, 1);
...
static size_t
ruby_sonor_vad_params_memsize(const void *p)
{
  const struct ruby_sonor_vad_params *params = p;
...
const rb_data_type_t ruby_sonor_vad_params_type = {
  "ruby_sonor_vad_params",
  {0, 0, ruby_sonor_vad_params_memsize,},
  0, 0,
  0
};

static VALUE
ruby_sonor_vad_params_s_allocate(VALUE klass)
{
  ruby_sonor_vad_params *rwvp;
  VALUE obj = TypedData_Make_Struct(klass, ruby_sonor_vad_params, &ruby_sonor_vad_params_type, rwvp);
  rwvp->params = sonor_vad_default_params();
  return obj;
}
 ...
 */
static VALUE
ruby_sonor_vad_params_set_threshold(VALUE self, VALUE value)
{
  ruby_sonor_vad_params *rwvp;
  TypedData_Get_Struct(self, ruby_sonor_vad_params, &ruby_sonor_vad_params_type, rwvp);
  rwvp->params.threshold = RFLOAT_VALUE(value);
  return value;
}

static VALUE
ruby_sonor_vad_params_get_threshold(VALUE self)
{
  ruby_sonor_vad_params *rwvp;
  TypedData_Get_Struct(self, ruby_sonor_vad_params, &ruby_sonor_vad_params_type, rwvp);
 ...
 */
static VALUE
ruby_sonor_vad_params_set_min_speech_duration_ms(VALUE self, VALUE value)
{
  ruby_sonor_vad_params *rwvp;
  TypedData_Get_Struct(self, ruby_sonor_vad_params, &ruby_sonor_vad_params_type, rwvp);
...
static VALUE
ruby_sonor_vad_params_get_min_speech_duration_ms(VALUE self)
{
  ruby_sonor_vad_params *rwvp;
  TypedData_Get_Struct(self, ruby_sonor_vad_params, &ruby_sonor_vad_params_type, rwvp);
 ...
 */
static VALUE
ruby_sonor_vad_params_set_min_silence_duration_ms(VALUE self, VALUE value)
{
  ruby_sonor_vad_params *rwvp;
  TypedData_Get_Struct(self, ruby_sonor_vad_params, &ruby_sonor_vad_params_type, rwvp);
...
static VALUE
ruby_sonor_vad_params_get_min_silence_duration_ms(VALUE self)
{
  ruby_sonor_vad_params *rwvp;
  TypedData_Get_Struct(self, ruby_sonor_vad_params, &ruby_sonor_vad_params_type, rwvp);
 ...
 */
static VALUE
ruby_sonor_vad_params_set_max_speech_duration_s(VALUE self, VALUE value)
{
  ruby_sonor_vad_params *rwvp;
  TypedData_Get_Struct(self, ruby_sonor_vad_params, &ruby_sonor_vad_params_type, rwvp);
...
static VALUE
ruby_sonor_vad_params_get_max_speech_duration_s(VALUE self)
{
  ruby_sonor_vad_params *rwvp;
  TypedData_Get_Struct(self, ruby_sonor_vad_params, &ruby_sonor_vad_params_type, rwvp);
 ...
 */
static VALUE
ruby_sonor_vad_params_set_speech_pad_ms(VALUE self, VALUE value)
{
  ruby_sonor_vad_params *rwvp;
  TypedData_Get_Struct(self, ruby_sonor_vad_params, &ruby_sonor_vad_params_type, rwvp);
...
static VALUE
ruby_sonor_vad_params_get_speech_pad_ms(VALUE self)
{
  ruby_sonor_vad_params *rwvp;
  TypedData_Get_Struct(self, ruby_sonor_vad_params, &ruby_sonor_vad_params_type, rwvp);
 ...
 */
static VALUE
ruby_sonor_vad_params_set_samples_overlap(VALUE self, VALUE value)
{
  ruby_sonor_vad_params *rwvp;
  TypedData_Get_Struct(self, ruby_sonor_vad_params, &ruby_sonor_vad_params_type, rwvp);
...
static VALUE
ruby_sonor_vad_params_get_samples_overlap(VALUE self)
{
  ruby_sonor_vad_params *rwvp;
  TypedData_Get_Struct(self, ruby_sonor_vad_params, &ruby_sonor_vad_params_type, rwvp);
...
static VALUE
ruby_sonor_vad_params_equal(VALUE self, VALUE other)
{
  ruby_sonor_vad_params *rwvp1;
  ruby_sonor_vad_params *rwvp2;
  ...
  TypedData_Get_Struct(self, ruby_sonor_vad_params, &ruby_sonor_vad_params_type, rwvp1);
  TypedData_Get_Struct(other, ruby_sonor_vad_params, &ruby_sonor_vad_params_type, rwvp2);
...
#define SET_PARAM_IF_SAME(param_name) \
  if (id == id_ ## param_name) { \
    ruby_sonor_vad_params_set_ ## param_name(self, value); \
    continue; \
  }

VALUE
ruby_sonor_vad_params_initialize(int argc, VALUE *argv, VALUE self)
{
  VALUE kw_hash;
...
void
init_ruby_sonor_vad_params(VALUE *mVAD)
{
  cVADParams = rb_define_class_under(*mVAD, "Params", rb_cObject);
  rb_define_alloc_func(cVADParams, ruby_sonor_vad_params_s_allocate);
  rb_define_method(cVADParams, "initialize", ruby_sonor_vad_params_initialize, -1);
  ...
  rb_define_method(cVADParams, "==", ruby_sonor_vad_params_equal, 1);
}
