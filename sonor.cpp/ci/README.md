...
In addition to [Github Actions](https://github.com/ggerganov/sonor.cpp/actions) `sonor.cpp` uses a custom CI framework:

https://github.com/ggml-org/ci

It monitors the `master` branch for new commits and runs the
[ci/run.sh](https://github.com/ggerganov/sonor.cpp/blob/master/ci/run.sh) script on dedicated cloud instances. This allows us
