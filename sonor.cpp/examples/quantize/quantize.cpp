...
// quantize a model
static bool sonor_model_quantize(const std::string & fname_inp, const std::string & fname_out, ggml_ftype ftype) {
    gpt_vocab vocab;
...
int main(int argc, char ** argv) {
    ...
    // load the model
    {
        ...
        if (!sonor_model_quantize(fname_inp, fname_out, ggml_ftype(ftype))) {
