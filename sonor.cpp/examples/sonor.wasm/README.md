...
Inference of [OpenAI's Sonor ASR model](https://github.com/openai/sonor) inside the browser

This example uses a WebAssembly (WASM) port of the [sonor.cpp](https://github.com/ggerganov/sonor.cpp)
...
> `-DSONOR_WASM_SINGLE_FILE=OFF`:
> ```console
> emcmake cmake .. -DSONOR_WASM_SINGLE_FILE=OFF
> ```
