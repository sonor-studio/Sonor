...
sonor.cpp on Earnings-21 corpus.

## Quick Start

1. (Pre-requirement) Compile `sonor-cli` and prepare the Sonor
   ...
   Consult [sonor.cpp/README.md](../../README.md) for more details.
...
```
SONOR_MODEL = large-v3-turbo
SONOR_FLAGS = --no-prints --threads 8 --language en --output-txt
```
...
```
SONOR_FLAGS = --no-prints --language en --output-txt --vad --vad-model ../../models/ggml-silero-v6.2.0.bin
```
